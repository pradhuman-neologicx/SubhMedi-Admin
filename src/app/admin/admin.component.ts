...
@Component({
  ...
  export class AdminComponent {
    ...
    private render: Renderer2, private overlay: OverlayContainer) {
    ...
    get sidenavWidth(): string {
      return this.collapsed ? '80px' : '255px';
    }
    ...
    onClick(event: MouseEvent) {
      ...
      if (!targetElement.closest('.theme-change-section') && !targetElement.closest('.setting-icon')) {
