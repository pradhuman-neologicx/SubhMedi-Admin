...
@Component({
  selector: 'app-medical-distributors',
  templateUrl: './medical-distributors.component.html',
  styleUrl: './medical-distributors.component.scss',
  animations: [
...
export class MedicalDistributorsComponent {
