...
@Component({
  selector: 'app-viewparties',
  templateUrl: './viewparties.component.html',
  styleUrl: './viewparties.component.scss'
})


  export class ViewpartiesComponent {
    ...
    console.log('partyID ID:', this.partyID);
    ...
    getpartyprojectbalance(type: any) {
      ...
      if (type === 0) {
        ...
        this.employeeService
          .getPartiesproject( this.partyID,
          ...
          .subscribe(
            (response: any) => {
              ...
              this.transactiontable = response.transactions ;
