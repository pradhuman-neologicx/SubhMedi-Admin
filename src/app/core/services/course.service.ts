...
export class CourseService {
  ...
  updateCourseStatus(courseId: string, isActive: boolean): Observable<any> {
    ...
    return this.apiservice.putWithoutHeader('course/updateStatus', body).pipe(
      tap((error: any) => {
  ...
  updateCoursesDetails(body: any) {
    ...
    return this.apiservice.put('course/updateCourse', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  PostCourses(formData: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.post('course/createCourse', formData, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  createEmployee(): Observable<any> {
    return this.apiservice.post('course/createCourse', {}, {}).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  UpdateBatchestatus(batchId: string, isActive: boolean): Observable<any> {
    ...
    return this.apiservice
      .putWithoutHeader('batch/updateBatchStatus', body)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  PostBatches(formData: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.post('batch/createBatch', formData, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  updateBatch(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.put('batch/updateBatch', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  updatesessionStatus(sessionId: string, isActive: boolean): Observable<any> {
    ...
    return this.apiservice.post('sessions/updateStatus', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  CreateSession(body: any) {
    ...
    return this.apiservice.post('sessions/createSession', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  updateSession(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.post('sessions/updateSession', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  Getbatchassign(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.post('batch/getAssignedBatch', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  Getbatchesfloor(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice
      .post('batch/getActiveNotAssignedBatch', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  Getassignuserfloor(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice
      .post('batch/assignMultipleBatchToUser', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  Unassignuserfloor(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice
      .post('batch/unassignUserFromBatch', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  Singleassignuserfloor(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.post('batch/assignUserToBatch', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  Addunitspost(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.post('dispatch-units/add-units', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  UpdateAddunitspost(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice
      .post('dispatch-units/update-units', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  getDispatchedmaterial(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice
      .post('dispatch-units/get-students', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  CreateUnitsIds(body: any) {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.apiservice
      .post('dispatch-units/units-by-course-subjects', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  dispatchstudents(body: any) {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.apiservice
      .post('dispatch-units/dispatch-material', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  Viewtabledispatchstudents(body: any) {
    const headers = new HttpHeaders().set('Content-Type', 'application/json');
    return this.apiservice
      .post('dispatch-units/dispatched-data', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  createtest(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice.post('test-series/create-test', body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        if (
          error.status === 422 &&
  ...
  updatetest(body: any, testId: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice
      .put('test-series/update-test/' + testId, body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  getCourseNameid(body: any) {
    const headers = { 'content-type': 'application/json' };
    return this.apiservice
      .post('masters/course-components-for-refund', body, headers)
      .pipe(
        tap((error: any) => {
          console.log('Response received:', error);
          if (
  ...
  GetpartyTypetableApi() {
    ...
    return this.apiservice.get('party-types', headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  createPartyApi(body: any): Observable<any> {
    ...
    return this.apiservice.post(`parties`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  UpdatePartyApi(body: any): Observable<any> {
    ...
    return this.apiservice.post(`edit-party-data`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  getPartyByIdAPI(PartyId: any): Observable<any> {
    ...
    return this.apiservice.post(`get-party-data`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  GetStaffApi(projectId: any, staff: any): Observable<any> {
    ...
    return this.apiservice.post(`get-parties-by-type`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  CreateWorkforceApi(body: any): Observable<any> {
    ...
    return this.apiservice.post(`create-workforce`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  CreateWorkerapi(body: any): Observable<any> {
    ...
    return this.apiservice.post(`add-party-workforce`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  GetStafflabourcontractorapi(partyid: any, projectId: any): Observable<any> {
    ...
    return this.apiservice.post(`get-workforce`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  MarkAttendacneapi(body: any): Observable<any> {
    ...
    return this.apiservice.post(`mark-attendance`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  UpdateLabourContratorAPI(body: any): Observable<any> {
    ...
    return this.apiservice.post(`update-attendance`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  getUpdateattendanceApi(
    ...
    return this.apiservice.post(`edit-attendance`, body, headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
  ...
  getShiftApi() {
    ...
    return this.apiservice.get('shifts', headers).pipe(
      tap((error: any) => {
        console.log('Response received:', error);
        this.erromessagefunction(error);
      })
